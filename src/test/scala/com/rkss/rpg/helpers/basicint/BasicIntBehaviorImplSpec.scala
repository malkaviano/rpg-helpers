...
final class BasicIntBehaviorImplSpec extends AnyFunSpec with Matchers {
  ...
  describe("BasicIntFixture behavior") {
    describe("initial value") {
      it("should be 10") {
        val fixture = BasicIntBehaviorImpl(name, BasicIntOptions(10))
    ...
    describe("minimum value") {
      it("should be 0") {
        val fixture = BasicIntBehaviorImpl(name, BasicIntOptions(10, 0))
          ...
          describe("and minimum is 30") {
            describe("and minimum changes to 52") {
              it("return minimum 30") {
                val fixture =
                  BasicIntBehaviorImpl(name, BasicIntOptions(40, 30, 50))
        ...
        describe("when options equalizeOnValueInferiorMinimum is true") {
          describe("and value is 10") {
            describe("and minimum changes to 20") {
              it("return value 20") {
                val fixture = BasicIntBehaviorImpl(
                  name,
    ...
    describe("maximum value") {
      it("should be 0") {
        val fixture = BasicIntBehaviorImpl(name, BasicIntOptions(10, 0, 50))
    ...
    describe("math operations") {
      it("should execute basic math") {
        val fixture = BasicIntBehaviorImpl(name)
    ...
    describe("rounding up on division") {
      it("should be 13") {
        val fixture =
          BasicIntBehaviorImpl(name, BasicIntOptions(100, roundUp = true))
    ...
    describe("on value changed") {
      describe("when a callback is defined") {
        it("should call the callback when value changes") {
          val fixture =
            BasicIntBehaviorImpl(name, BasicIntOptions(10, 0, 50))
